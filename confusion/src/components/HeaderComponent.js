            ...
            <ModalBody>
               <Form onSubmit={this.handleLogin}>
                 <FormGroup>
                   ...
                   <Input type="text" id="username" name="username" inneRef={(input) => this.username = input}/>
                 </FormGroup>
                 <FormGroup>
                   <Label htmlFor="password">Password</Label>
                   <Input type="password" id="password" name="password" inneRef={(input) => this.password = input} />
                 </FormGroup>
                 <FormGroup check>
                    <Label check>
                      <Input type="checkbox" name="remember" inneRef={(input) => this.remember = input} />
                      Remember me
                    </Label>
                 </FormGroup>
